...
const NavBar = (props) => {
    return (
      <div className={topnav}>
        <div className={(props.activelink === "Home") ? active : navlink}><Link to="/">Home</Link></div>
        ...
        <div className={(props.activelink === "Proj") ? active : navlink}><Link to="/blog">Projects</Link></div>
      </div>
      )
}
